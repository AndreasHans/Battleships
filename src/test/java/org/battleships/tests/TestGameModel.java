...
public class TestGameModel {
    ...
    public void test1x1num1() throws InterruptedException {
        Ship ship = new Ship();
        ship.setPoints(gameModel.makeNbyM(1,1));
    ...
    public void test2x2num1() throws InterruptedException {
        Ship ship = new Ship();
        ship.setPoints(gameModel.makeNbyM(2,2));
    ...
    public void testMultipleShips1() throws InterruptedException {
        ...
        Ship ship2 = new Ship();
        ship2.setPoints(gameModel.makeNbyM(1,1));
    ...
    public void testMultipleShips2() throws InterruptedException {
        ...
        Ship ship2 = new Ship();
        ship2.setPoints(gameModel.makeNbyM(3,1));
